...
open class DatePickerDialog: UIView {
    ...
    open func show(_ title: String,
        ...
        print("self.datePickerMode")
        print(title)
//        if self.datePickerMode == UIDatePicker.Mode.time {
...
//        self.titleLabel.textColor = UIColor.init(red: (252/255), green: (182/255), blue: (20/255), alpha: 1.0)
    ...
    private func addButtonsToView(container: UIView) {
        ...
        self.doneButton.layer.backgroundColor = #colorLiteral(red: 0.6649263501, green: 0.2532883584, blue: 0.5774737, alpha: 1)
