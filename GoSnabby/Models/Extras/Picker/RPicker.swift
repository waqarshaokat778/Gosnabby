...
open class PickerDialog: UIView , UIPickerViewDelegate , UIPickerViewDataSource{
    ...
    open func show(_ title: String,
                   doneButtonTitle: String = "Done1",
                   cancelButtonTitle: String = "Cancel1",
                   arrayMain: [String],
...
//        print("self.doneButton.frame22")
//        print(self.doneButton.frame)
...
//        print(container.frame)
    ...
    private func addButtonsToView(container: UIView) {
        ...
        self.doneButton.layer.backgroundColor = kConstantsColors.kAppBluecolor.cgColor
